...
//	{
//		System.out.println(MasterSolver ("(3x^9 + 5x^7 + 9)^3+8x^2"));
//	}

	public static ArrayList<String> SingleTermOrNah(String input)
    {
        //first method initiated if chain. Checks if there are separable terms, and how many.
    ...
    public static String MasterSolver(String inputOne)
    {
